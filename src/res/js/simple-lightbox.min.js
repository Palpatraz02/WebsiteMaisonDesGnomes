                ...
                var t = function () {
                    ...
                    return t = n, (e = [{
                        ...
                        key: "toggleScrollbar", value: function (t) {
                            var i = 0, e = [].slice.call(document.querySelectorAll("." + this.options.fixedClass));
                            if ("hide" === t) {
                        ...
                        key: "preload", value: function () {
                            var o = this, i = this.currentImageIndex, t = this.relatedElements.length,
                                e = i + 1 < 0 ? t - 1 : t - 1 <= i + 1 ? 0 : i + 1,
                                n = i - 1 < 0 ? t - 1 : t - 1 <= i - 1 ? 0 : i - 1, s = new Image, a = new Image;
                        ...
                        key: "adjustImage", value: function (a) {
                            ...
                            var t = new Image, l = window.innerWidth * this.options.widthRatio,
